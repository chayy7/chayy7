...
<div align="center" style="margin-bottom: -40px;">
  <svg viewBox="0 0 1440 100" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" style="width: 100%; height: 80px; display: block;">
    <path fill="#a8dadc" fill-opacity="1" d="M0,64L48,80C96,96,192,128,288,128C384,128,480,96,576,90.7C672,85,768,107,864,122.7C960,139,1056,149,1152,144C1248,139,1344,117,1392,106.7L1440,96L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
  </svg>
</div>

<div align="center" style="background: linear-gradient(135deg, #a8dadc, #457b9d); padding: 20px 10px; border-radius: 15px; box-shadow: 0 8px 15px rgba(70, 130, 180, 0.3); max-width: 850px; margin: auto;">
  <img src="https://github-readme-stats.vercel.app/api?username=chayy7&show_icons=true&hide_border=true&theme=transparent" width="48%" style="background: transparent; border-radius: 15px;" />
  <img src="https://github-readme-streak-stats.herokuapp.com?user=chayy7&hide_border=true&theme=transparent" width="48%" style="background: transparent; border-radius: 15px;" />
</div>

<!-- Bottom wave SVG -->
<div align="center" style="margin-top: -40px;">
  <svg viewBox="0 0 1440 100" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" style="width: 100%; height: 80px; display: block; transform: rotate(180deg);">
    <path fill="#a8dadc" fill-opacity="1" d="M0,64L48,80C96,96,192,128,288,128C384,128,480,96,576,90.7C672,85,768,107,864,122.7C960,139,1056,149,1152,144C1248,139,1344,117,1392,106.7L1440,96L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
  </svg>
</div>

<p align="center" style="margin-top: 10px;">
  <div style="background: linear-gradient(135deg, #74c69d, #40916c); padding: 12px 18px; display: inline-block; border-radius: 15px; box-shadow: 0 6px 12px rgba(64, 145, 108, 0.3);">
